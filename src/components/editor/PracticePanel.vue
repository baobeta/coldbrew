  ...
  <div class="border-t border-border bg-bg-sidebar px-6 py-4 max-md:px-4">
    <div class="max-w-[720px] mx-auto">
      ...
      <div class="mb-3">
        ...
        <div class="text-base text-text font-body leading-relaxed bg-white rounded-lg px-4 py-3 border border-border">
          {{ targetText }}
        </div>
      </div>
      ...
      <div v-else-if="isRecording" class="mb-3">
        ...
        <div class="bg-white rounded-lg px-4 py-3 border border-accent/30 text-base text-text-muted font-body italic">
      ...
      <div v-if="remotePractice?.score != null && !hasResult" class="mb-3">
        <div class="text-sm text-text-muted">
          ...
          <span v-if="remotePractice.score === remotePractice.total" class="text-green-600 ml-1">Perfect!</span>
        </div>
      </div>
      ...
      <div class="flex gap-2">
        ...
        >
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <rect x="5" y="1" width="4" height="8" rx="2" stroke="currentColor" stroke-width="1.3" fill="none"/>
            <path d="M3 6.5a4 4 0 0 0 8 0" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" fill="none"/>
        ...
        >
          <svg width="14" height="14" viewBox="0 0 14 14" fill="none">
            <path d="M1.5 5v4h2.5l3.5 2.5V2.5L4 5H1.5z" stroke="currentColor" stroke-width="1.2" fill="none" stroke-linejoin="round"/>
            <path d="M9.5 4.5a2.5 2.5 0 0 1 0 5" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" fill="none"/>
            <path d="M11 3a5 5 0 0 1 0 8" stroke="currentColor" stroke-width="1.2" stroke-linecap="round" fill="none"/>
          </svg>
          Listen
        </button>
        <button
