<template>
  <div class="flex items-center justify-center min-h-screen p-8">
    <div class="text-center max-w-[480px]">
      ...
      <button
        class="inline-block px-8 py-3 text-base font-ui font-medium text-white bg-accent border-none rounded-lg cursor-pointer transition-colors hover:bg-accent-hover"
        @click="createRoom"
      >
        Create new room
      </button>
